...
<template>
  <div class="relative flex items-top justify-center min-h-screen bg-gray-100 sm:items-center sm:pt-0">
    ...
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
      <a class="text-2xl leading-7 font-semibold flex justify-center pt-8 sm:pt-0" href="http://localhost:8189/sh/swagger-ui/" target="_blank">
        Scheduler
      </a>
      <div class="mt-8 bg-white overflow-hidden shadow sm:rounded-lg p-6">
        ...
        <p class="mt-4 pt-4 text-gray-800 border-t border-dashed">
          <b>На примере учеников муз школы</b> : у преподавателя есть временной интервал,
        ...
        <p class="mt-4 pt-4 text-gray-800 border-t border-dashed">
          <b>А после утверждения расписания, сделать возможным следующее:</b>
